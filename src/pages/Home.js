                                ...
                                <div class="text-center pb-12 md:pb-7">
                                    ...
                                    <div className="max-w-3xl mx-auto">
                                        ...
                                        <div class="flex flex-col justify-between p-4 leading-normal">
                                            <a class="inline-flex place-items-stretch px-3 py-2 text-sm font-medium text-center text-white bg-blue-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" href="/bestCutting">Best Cutting</a>
                                        </div>
                                        <div class="flex flex-col justify-between p-4 leading-normal">
                                            <a class="inline-flex place-items-stretch px-3 py-2 text-sm font-medium text-center text-white bg-blue-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" href="/faceShape">Face Shapes</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
